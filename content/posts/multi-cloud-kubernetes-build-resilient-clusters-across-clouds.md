...
description: "Multi-Cloud Kubernetes: Build Resilient Clusters Across Clouds"
sources:
...
|---|---|---|
| advanced | kubernetes | kubernetes, multi-cloud, resilience |
...
> **Did you know?**
> The term 'Kubernetes' originates from Greek, meaning 'helmsman' or 'pilot,' which perfectly describes its role in steering containerized applications across complex infrastructure landscapes.
...
1. [Kubernetes Multi-Cluster Documentation](https://kubernetes.io/docs/tasks/administer-cluster/multi-cluster/) — documentation
2. [CNCF Multi-Cloud Whitepaper](https://www.cncf.io/wp-content/uploads/2022/03/CNCF_Multi-Cloud_Whitepaper_v1.pdf) — documentation
3. [Istio Multi-Cloud Networking](https://istio.io/latest/docs/tasks/traffic-management/multi-cluster/) — documentation
4. [Multi-Cloud Database Strategies](https://aws.amazon.com/blogs/database/multi-cloud-database-strategies/) — blog
5. [HashiCorp Vault Multi-Cloud](https://www.vaultproject.io/docs/platform/k8s) — documentation
6. [Rancher Multi-Cloud Management](https://rancher.com/docs/rancher/v2.6/en/overview/) — documentation
7. [Google Anthos Multi-Cloud](https://cloud.google.com/anthos) — documentation
8. [Azure Arc Kubernetes](https://docs.microsoft.com/en-us/azure/azure-arc/kubernetes/) — documentation
9. [Red Hat OpenShift Multi-Cloud](https://www.redhat.com/en/technologies/cloud-computing/openshift/multi-cloud) — documentation
10. [Terraform Multi-Cloud Provider](https://www.terraform.io/docs/cloud/index.html) — documentation
11. [ArgoCD GitOps for Multi-Cloud](https://argoproj.github.io/argo-cd/) — documentation
12. [Prometheus Multi-Cloud Monitoring](https://prometheus.io/docs/practices/multi_cluster/) — documentation
