...
tags: ["unix"]
description: "The Silent Killer: When Your Linux Processes Vanish into Uninterruptible Sleep"
...
> **Did you know?**
> The D state was introduced in early Unix systems to prevent data corruption during critical I/O operations. The name 'uninterruptible sleep' comes from the fact that these processes cannot be woken up by signals - they're truly waiting for hardware to complete its operation.
...
1. [Searching for the cause of hung tasks in the Linux kernel](https://blog.cloudflare.com/searching-for-the-cause-of-hung-tasks-in-the-linux-kernel/) — blog
2. [Process states in Linux](https://man7.org/linux/man-pages/man5/proc.5.html) — documentation
3. [Linux I/O stack and debugging](https://www.kernel.org/doc/html/latest/block/index.html) — documentation
4. [Understanding uninterruptible sleep](https://en.wikipedia.org/wiki/Process_state) — article
5. [Linux OOM Killer](https://lwn.net/Articles/317814/) — article
6. [I/O Performance Monitoring](https://www.kernel.org/doc/Documentation/ABI/testing/sysfs-block) — documentation
7. [BPF Performance Tools](https://github.com/iovisor/bcc) — documentation
8. [drgn debugger](https://github.com/osandov/drgn) — documentation
9. [Linux System Call Reference](https://man7.org/linux/man-pages/man2/syscalls.2.html) — documentation
10. [Kernel debugging techniques](https://www.kernel.org/doc/html/latest/admin-guide/bug-hunting.html) — documentation
