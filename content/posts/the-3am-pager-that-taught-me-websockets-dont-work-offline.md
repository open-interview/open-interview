...
description: "The 3am Pager That Taught Me WebSockets Don't Work Offline"
question: "You're building a real-time food delivery tracking app. How would you implement a WebSocket connection that handles network interruptions and maintains order status updates when the app goes offline?"
sources:
...
|---|---|---|
| intermediate | frontend | dom, fetch, websocket, service-worker |
...
> **Did you know?**
> The first WebSocket implementation was created in 2010, but it took until 2016 for browsers to properly support service workers - the missing piece that made offline-first real-time apps actually viable in production.
...
**Q:** You're building a real-time food delivery tracking app. How would you implement a WebSocket connection that handles network interruptions and maintains order status updates when the app goes offline?

**A:** Use WebSocket with exponential backoff retry, service worker for offline caching, and IndexedDB for local state persistence.
...
1. [Uber Engineering: Building Resilient Real-Time Features](https://www.uber.com/blog/building-resilient-real-time-features/) — blog
2. [MDN: Using Service Workers](https://developer.mozilla.org/en-US/docs/Web/API/Service_Worker_API/Using_Service_Workers) — documentation
3. [Google Web Dev: Offline-first Apps](https://web.dev/offline-first/) — documentation
4. [Netflix: The Evolution of Their Playback Architecture](https://netflixtechblog.com/the-evolution-of-the-netflix-playback-architecture-5a04302205da) — blog
