...
description: "Mastering API Rate Limiting and Throttling: Practical Patterns for Resilient APIs"
sources:
...
> **Did you know?**
> Edge rate limiting can dramatically reduce traffic reaching origin servers, enabling massive scale while keeping latency low and protecting against abuse 6.
...
1. [Google Cloud - Rate Limiting Strategies](https://cloud.google.com/architecture/rate-limiting-strategies-techniques) — blog
2. [AWS API Gateway Throttling](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-request-throttling.html) — docs
3. [Twitter API Rate Limits](https://developer.twitter.com/en/docs/twitter-api/rate-limits) — docs
4. [GitHub API Rate Limiting](https://docs.github.com/en/rest/overview/resources-in-the-rest-api#rate-limiting) — docs
5. [Redis INCR - Rate Limiting](https://redis.io/commands/incr/) — blog
6. [Cloudflare - Rate Limiting at Scale](https://blog.cloudflare.com/counting-things-a-lot-of-different-things/) — blog
7. [Kong - Rate Limiting Algorithm Design](https://konghq.com/blog/how-to-design-a-scalable-rate-limiting-algorithm) — blog
8. [NGINX Rate Limiting](https://www.nginx.com/blog/rate-limiting-nginx/) — blog
