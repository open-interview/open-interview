...
description: "The Multi-Million Dollar Bug: How Uber Saved UberEats from Data Apocalypse"
...
|---|---|---|
| intermediate | data-engineering | dag, orchestration, scheduling |
...
> **Did you know?**
> The concept of exactly-once processing was first formalized in the 1970s database research papers, but it took until 2017 for Apache Kafka to implement it at scale for message queues. The original papers used mathematical proofs that would make even theoretical computer scientists sweat!
...
1. [Real-Time Exactly-Once Ad Event Processing with Apache Flink, Kafka, and Pinot](https://www.uber.com/blog/real-time-exactly-once-ad-event-processing/) — blog
2. [CAP Theorem](https://en.wikipedia.org/wiki/CAP_theorem) — documentation
3. [Kafka Transactions Documentation](https://kafka.apache.org/documentation/#transactions) — documentation
4. [Database Transaction Patterns](https://docs.microsoft.com/en-us/azure/architecture/patterns/category/data-management) — documentation
5. [Kafka Performance Benchmarks](https://kafka.apache.org/documentation/#performance) — documentation
6. [Two-Phase Commit Protocol](https://en.wikipedia.org/wiki/Two-phase_commit_protocol) — documentation
7. [Kafka Broker Elections](https://kafka.apache.org/documentation/#design_replicatedlog_leader_election) — documentation
8. [Apache Flink Documentation](https://flink.apache.org/documentation/) — documentation
9. [Database Transaction Management](https://www.postgresql.org/docs/current/transaction-iso.html) — documentation
10. [Exponential Backoff Pattern](https://en.wikipedia.org/wiki/Exponential_backoff) — documentation
11. [Message Queue Design Patterns](https://docs.aws.amazon.com/prescriptive-guidance/latest/patterns/queue-based-load-leveling.html) — documentation
