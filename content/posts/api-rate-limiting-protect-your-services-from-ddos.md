...
description: "API Rate Limiting: Protect Your Services from DDoS"
sources:
...
|---|---|---|
| intermediate | backend | rate-limiting, api, ddos |
...
> **Did you know?**
> The first major DDoS attack in 2000 took down major websites including Yahoo, Amazon, and eBay for hours, sparking the modern rate limiting industry
...
1. [Express Rate Limit Documentation](https://github.com/express-rate-limit/express-rate-limit) — documentation
2. [HTTP Rate Limiting Headers RFC](https://tools.ietf.org/html/rfc6585) — documentation
