...
difficulty: advanced
tags: ["advanced", "cloud"]
description: "Drift, Disrupted: How a Centralized Platform Tames IaC at Scale"
question: What is Infrastructure Drift and how do you detect and prevent it?
sources:
...
|---|---|---|
| advanced | terraform | advanced, cloud |
...
> **Did you know?**
> Many teams underestimate drift until audits force a discovery—the real cost shows up in unplanned outages and failed compliance checks.
...
**Q:** What is Infrastructure Drift and how do you detect and prevent it?

**A:** Infrastructure Drift occurs when actual infrastructure state diverges from the desired state defined in code, typically due to manual changes or concurrent modifications.
...
1. [Western Union Scales Cloud Infrastructure and Optimizes Costs](https://www.env0.com/customers/western-union-scales-cloud-infrastructure-and-optimizes-costs) — article
2. [Infrastructure as Code](https://en.wikipedia.org/wiki/Infrastructure_as_Code) — article
3. [Drift detection in AWS CloudFormation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/drift-detection.html) — documentation
4. [Terraform plan](https://www.terraform.io/docs/commands/plan.html) — documentation
5. [Terraform state show](https://www.terraform.io/docs/commands/state/show.html) — documentation
6. [Terraform fmt](https://www.terraform.io/docs/commands/fmt.html) — documentation
7. [Terraform validate](https://www.terraform.io/docs/commands/validate.html) — documentation
8. [terraform-aws-modules/terraform-aws-vpc](https://github.com/terraform-aws-modules/terraform-aws-vpc) — repository
9. [What is AWS Config?](https://docs.aws.amazon.com/config/latest/developerguide/what-is-aws-config.html) — documentation
