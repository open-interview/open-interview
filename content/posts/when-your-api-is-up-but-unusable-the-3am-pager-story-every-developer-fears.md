...
description: "When Your API Is Up But Unusable: The 3AM Pager Story Every Developer Fears"
...
|---|---|---|
| beginner | sre | prometheus, grafana, opentelemetry |
...
> **Did you know?**
> The term 'observability' was coined by Hungarian engineer Rudolf Kálmán in the 1960s for control theory, but wasn't applied to software systems until Google's SRE team popularized it in the 2010s 10.
...
1. [The Stripe Latency Post-Mortem Every Engineer Should Read Before Launching Their API](https://medium.com/@warstories/the-stripe-latency-post-mortem-every-engineer-should-read-before-launching-their-api-6514411772f8) — blog
2. [Prometheus Querying Documentation](https://prometheus.io/docs/prometheus/latest/querying/) — documentation
3. [Histograms and Summaries in Prometheus](https://prometheus.io/docs/practices/histograms/) — documentation
4. [Grafana Dashboard Best Practices](https://grafana.com/docs/grafana/latest/best-practices/) — documentation
5. [Circuit Breaker Pattern](https://martinfowler.com/bliki/CircuitBreaker.html) — blog
6. [Google SRE Book: Monitoring Distributed Systems](https://sre.google/books/chapters/monitoring-distributed-systems/) — documentation
7. [Kubernetes Observability Best Practices](https://kubernetes.io/docs/tasks/debug/debug-application/) — documentation
8. [Site Reliability Engineering](https://sre.google/books/) — documentation
9. [Distributed Systems Observability](https://opentelemetry.io/docs/concepts/observability-primer/) — documentation
10. [Chaos Engineering for Resilience](https://principlesofchaos.org/) — documentation
