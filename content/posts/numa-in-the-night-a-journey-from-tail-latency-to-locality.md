...
difficulty: advanced
tags: ["linux"]
description: "NUMA in the Night: A Journey from Tail Latency to Locality"
...
> **Did you know?**
> Tail latency isn’t just about slow code; sometimes it’s about where memory lives in a multi-socket machine.
...
1. [How Expensify achieves extreme concurrency with NUMA balancing](https://use.expensify.com/blog/how-expensify-achieves-concurrency-with-numa-balancing) — article
2. [Non-Uniform Memory Access](https://en.wikipedia.org/wiki/Non-Uniform_Memory_Access) — encyclopedia
3. [NUMA architecture in Linux](https://www.kernel.org/doc/html/latest/mm/numa.html) — documentation
4. [numactl(8) manual](https://linux.die.net/man/8/numactl) — manual
5. [numastat(1) manual](https://linux.die.net/man/1/numastat) — manual
6. [Procfs](https://en.wikipedia.org/wiki/Procfs) — encyclopedia
7. [/proc/[pid]/numa_maps (procfs documentation)](https://man7.org/linux/man-pages/man5/proc.5.html) — manual
8. [CPU affinity](https://en.wikipedia.org/wiki/CPU_affinity) — encyclopedia
9. [numactl repository](https://github.com/numactl/numactl) — repository
10. [Linux kernel source](https://github.com/torvalds/linux) — repository
11. [Cache coherence](https://en.wikipedia.org/wiki/Cache_coherence) — encyclopedia
