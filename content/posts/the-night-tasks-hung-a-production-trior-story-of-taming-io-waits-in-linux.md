...
difficulty: advanced
tags: ["unix"]
description: "The Night Tasks Hung: A Production-Trior story of taming I/O waits in Linux"
...
> **Did you know?**
> In 2025, a major cloud provider reported that tuning hung-task detection thresholds reduced incident toil by a factor of 3
...
1. [Searching for the cause of hung tasks in the Linux kernel](https://blog.cloudflare.com/searching-for-the-cause-of-hung-tasks-in-the-linux-kernel/) — article
2. [Uninterruptible Sleep](https://www.baeldung.com/linux/uninterruptible-process) — blog
3. [Simulate an unkillable process in D state](https://unix.stackexchange.com/questions/134888/simulate-an-unkillable-process-in-d-state) — documentation
4. [strace(1) - Linux manual page](https://man7.org/linux/man-pages/man1/strace.1.html) — documentation
5. [/proc/pid/status - memory usage and status information](https://manpages.ubuntu.com/manpages/noble/man5/proc_pid_status.5.html) — documentation
6. [proc_pid_status(5) — Arch manual pages](https://man.archlinux.org/man/proc_pid_status.5.en) — documentation
7. [proc_pid_status(5) — Debian standard Debian manpages](https://manpages.debian.org/testing/manpages/proc_pid_status.5.en.html) — documentation
8. [Troubleshooting a stuck process](https://www.joshmcguigan.com/blog/troubleshooting-stuck-process/) — blog
9. [How to Use strace for Troubleshooting on Ubuntu](https://oneuptime.com/blog/post/2026-01-15-use-strace-troubleshooting-ubuntu/view) — blog
10. [Concurrency Testing in the Linux Kernel via eBPF](https://arxiv.org/abs/2508.15703) — paper
11. [Linux's Hung Task Detector Will Be Able To Reset For Easing System Administration](https://www.phoronix.com/news/Linux-Reset-Hung-Task-Count) — blog
12. [The case of the vanishing CPU: A Linux kernel debugging story](https://clickhouse.com/blog/a-case-of-the-vanishing-cpu-a-linux-kernel-debugging-story) — blog
13. [Load (computing) - Wikipedia](https://en.wikipedia.org/wiki/Load_(computing)) — documentation
14. [proc_pid_status(5) — Arch manual pages (duplicate reference for completeness)](https://man.archlinux.org/man/proc_pid_status.5.en) — documentation
15. [The Linux kernel hung task discussion (Cloudflare community mirror)](https://community.cloudflare.com/t/searching-for-the-cause-of-hung-tasks-in-the-linux-kernel/771005) — blog
16. [The story of one latency spike (Cloudflare)](https://blog.cloudflare.com/the-story-of-one-latency-spike/) — blog
