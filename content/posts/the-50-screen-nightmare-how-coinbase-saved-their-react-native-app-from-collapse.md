...
difficulty: advanced
tags: ["react-native"]
description: "The 50-Screen Nightmare: How Coinbase Saved Their React Native App from Collapse"
question: "How would you optimize a React Native app with 50+ screens that's experiencing slow navigation and memory leaks, particularly on lower-end devices?"
sources:
...
|---|---|---|
| advanced | react-native | react-native |

Picture this: Your CEO just tweeted about the new feature, but users are complaining about sluggish navigation and UI jank. This was exactly the nightmare Coinbase faced when their React Native Android app started buckling under its own weight, with performance degrading to the point where user experience was significantly impacted 1. The culprit? A silent killer lurking in your codebase that affects every React Native app with 50+ screens.
...
> **Did you know?**
> The Hermes JavaScript engine was named after the Greek messenger god, fitting for something that delivers faster performance to React Native apps. It was originally developed for Facebook's mobile apps and reduced their JavaScript execution time by 40%!
...
1. [Optimizing React Native](https://www.coinbase.com/blog/optimizing-react-native) — blog
2. [Metro Bundler Documentation](https://metrobundler.dev/docs/bundling) — documentation
3. [MDN WeakMap Documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/WeakMap) — documentation
4. [React Native FlatList Performance](https://reactnative.dev/docs/flatlist#performance) — documentation
5. [Hermes JavaScript Engine](https://hermesengine.dev/) — documentation
6. [Android ProGuard Guide](https://developer.android.com/studio/build/shrink-code) — documentation
7. [React.memo Documentation](https://reactjs.org/docs/react-api.html#reactmemo) — documentation
8. [Flipper Debugging Tool](https://fbflipper.com/) — documentation
9. [React DevTools Profiler](https://reactjs.org/blog/2018/09/10/introducing-the-react-profiler.html) — blog
10. [React Native Performance Best Practices](https://reactnative.dev/docs/performance) — documentation
