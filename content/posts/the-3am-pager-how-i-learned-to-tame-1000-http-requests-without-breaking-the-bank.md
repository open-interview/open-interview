...
description: "The 3am Pager: How I Learned to Tame 1000 HTTP Requests Without Breaking the Bank"
...
|---|---|---|
| intermediate | python | asyncio, aiohttp, concurrency |
...
> **Did you know?**
> The concept of rate limiting was invented in 1875 for telegraph systems! They needed to prevent operators from sending messages too fast, which would overwhelm the manual switching systems. The same principle applies to our modern HTTP APIs - just with much cooler technology.
...
1. [Python AsyncIO Documentation](https://docs.python.org/3/library/asyncio.html) — documentation
2. [aiohttp Client Session Documentation](https://docs.aiohttp.org/en/stable/client_reference.html) — documentation
3. [Rate Limiting Algorithms Comparison](https://en.wikipedia.org/wiki/Rate_limiting) — documentation
4. [Token Bucket Algorithm Explained](https://en.wikipedia.org/wiki/Token_bucket) — documentation
5. [Exponential Backoff in Distributed Systems](https://aws.amazon.com/blogs/architecture/exponential-backoff-and-jitter/) — blog
6. [Tenacity Retry Library](https://github.com/jd/tenacity) — documentation
7. [HTTP Client Timeouts Best Practices](https://docs.aiohttp.org/en/stable/client_advanced.html#timeouts) — documentation
8. [AsyncIO Semaphore Reference](https://docs.python.org/3/library/asyncio-sync.html#asyncio.Semaphore) — documentation
9. [Microservices Rate Limiting Patterns](https://kubernetes.io/docs/concepts/cluster-administration/flow-control/) — documentation
