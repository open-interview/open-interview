...
description: The Terraform Architecture That Saved Capital One From Multi-Environment Chaos
...
|---|---|---|
| advanced | terraform | infrastructure-as-code, automation, best-practices |
...
1. [Deploying multiple environments with Terraform](https://capitalone.com/tech/software-engineering/deploying-multiple-environments-with-terraform) — blog
2. [Terraform State Locking with DynamoDB](https://docs.aws.amazon.com/AmazonS3/latest/userguide/example-walkthroughs-managing-versioning-enabled-buckets.html) — documentation
3. [Checkov Security Scanner](https://github.com/bridgecrewio/checkov) — documentation
4. [AWS Server-Side Encryption](https://docs.aws.amazon.com/AmazonS3/latest/userguide/UsingServerSideEncryption.html) — documentation
5. [Open Policy Agent (OPA)](https://www.openpolicyagent.org/) — documentation
6. [AWS Cost Allocation Tags](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/cost-allocation-tags.html) — documentation
7. [Infracost Cost Estimation](https://github.com/infracost/infracost) — documentation
8. [TFLint Terraform Linter](https://github.com/terraform-linters/tflint) — documentation
9. [AWS CloudTrail Audit Logging](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/) — documentation
10. [Terraform Workspaces Documentation](https://developer.hashicorp.com/terraform/cli/workspaces) — documentation
11. [Infrastructure as Code Security Best Practices](https://docs.aws.amazon.com/securityhub/latest/userguide/infrastructure-as-code-security.html) — documentation
