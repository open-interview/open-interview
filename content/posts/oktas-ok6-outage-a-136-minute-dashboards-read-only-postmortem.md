...
description: "Okta's OK6 Outage: A 136-Minute Dashboards Read-Only Postmortem"
sources:
...
|---|---|---|
| advanced | system-design | outage, incident, postmortem |
...
> **Did you know?**
> Okta operates a highly distributed identity platform; even a single cell outage requires precise containment to prevent wider impact.
...
1. [OK6 Okta Dashboard Access](https://status.okta.com/incidents/I-9905) — postmortem
2. [Site Reliability Engineering](https://sre.google/sre-book/table-of-contents/) — documentation
3. [The Site Reliability Workbook](https://sre.google/workbook/table-of-contents/) — documentation
4. [Building Secure &amp; Reliable Systems](https://google.github.io/building-secure-and-reliable-systems/raw/toc.html) — documentation
5. [Twenty Years of SRE Lessons Learned](https://goo.gle/sre-20-ll) — documentation
6. [NIST SP 800-61 Rev. 2: Computer Security Incident Handling Guide](https://csrc.nist.gov/publications/detail/sp/800-61/rev-2/final) — documentation
7. [NIST Press Release: Updated NIST Guide on Dealing with Computer Security Incidents](https://www.nist.gov/news-events/news/2012/08/updated-nist-guide-how-dealing-computer-security-incidents) — documentation
