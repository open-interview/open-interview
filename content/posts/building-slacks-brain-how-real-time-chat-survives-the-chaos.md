...
description: "Building Slack's Brain: How Real-Time Chat Survives the Chaos"
...
|---|---|---|
| advanced | system-design | dist-sys, cap-theorem, consensus |
...
> **Did you know?**
> The first CRDT was invented in 2011, but the mathematical foundations date back to the 1970s. It took 40 years for the theory to catch up to the practical need!
...
1. [The Raft Consensus Algorithm](https://raft.github.io/) — documentation
2. [Discord's Architecture Blog](https://discord.com/blog/how-discord-scales-e10-websockets) — blog
3. [CRDTs: The Magic of Distributed Data](https://concordant.io/crdt-101/) — documentation
4. [Event Sourcing Explained](https://martinfowler.com/articles/event-sourcing.html) — blog
