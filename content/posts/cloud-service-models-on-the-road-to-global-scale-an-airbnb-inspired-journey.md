...
description: "Cloud Service Models on the Road to Global Scale: An Airbnb-Inspired Journey"
question: "Compare AWS IaaS, PaaS, and SaaS service models with specific examples and use cases?"
sources:
...
|---|---|---|
| intermediate | aws | cloud, aws, azure, gcp |
...
> **Did you know?**
> The term cloud in cloud computing originated as a metaphor for the internet in network diagrams, representing something abstracted away from the user.
...
1. [Airbnb – Reinventing the Hospitality Industry on AWS](https://aws.amazon.com/blogs/aws/airbnb-reinventing-the-hospitality-industry-on-aws) — article
2. [Cloud computing service models](https://en.wikipedia.org/wiki/Cloud_computing#Service_models_(IaaS,_PaaS,_SaaS)) — documentation
3. [What is Amazon EC2?](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/concepts.html) — documentation
4. [What is AWS Elastic Beanstalk](https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/what-is-eb.html) — documentation
5. [Getting started with AWS Lambda](https://docs.aws.amazon.com/lambda/latest/dg/welcome.html) — documentation
6. [Amazon RDS User Guide](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Welcome.html) — documentation
7. [Amazon Chime Developer Guide](https://docs.aws.amazon.com/chime) — documentation
8. [Kubernetes — What is Kubernetes?](https://kubernetes.io/docs/concepts/overview/what-is-kubernetes/) — documentation
9. [GitHub: kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) — repository
10. [RFC 7231: Hypertext Transfer Protocol (HTTP/1.1) Semantics](https://datatracker.ietf.org/doc/html/rfc7231) — documentation
11. [What is cloud computing?](https://www.digitalocean.com/community/tutorials/what-is-cloud-computing) — tutorial
12. [Microservices at Spotify](https://martinfowler.com/articles/microservices.html) — article
13. [What is Kubernetes?](https://en.wikipedia.org/wiki/Kubernetes) — documentation
