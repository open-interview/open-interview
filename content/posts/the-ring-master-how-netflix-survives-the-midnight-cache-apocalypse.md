...
description: "The Ring Master: How Netflix Survives the Midnight Cache Apocalypse"
...
|---|---|---|
| advanced | system-design | hashing, dist-sys, caching |
...
> **Did you know?**
> The number 160 for virtual nodes isn't random! It comes from Dynamo's research showing that 150-200 virtual nodes provide the best balance between load distribution and memory overhead. Fewer than 100 cause hotspots, more than 200 waste memory.
...
1. [Dynamo: Amazon's Highly Available Key-value Store](https://www.allthingsdistributed.com/files/amazon-dynamo-sosp2007.pdf) — paper
2. [Netflix EVCache Architecture](https://netflixtechblog.com/evcache-architecture-and-implementation-238e3215b2c7) — blog
3. [Cassandra Consistent Hashing Documentation](https://cassandra.apache.org/_/latest/cassandra/architecture/partitioning.html) — documentation
4. [Redis Cluster Specification](https://redis.io/docs/reference/cluster-spec/) — documentation
