...
difficulty: beginner
tags: ["yolo", "rcnn", "detr"]
description: "When Real-Time Vision Meets Edge: How YOLO Learns to See at AWS-Scale Speed"
question: How does YOLO implement real-time object detection using grid-based prediction and what are the key components of its architecture?
sources:
...
|---|---|---|
| beginner | computer-vision | yolo, rcnn, detr |
...
> **Did you know?**
> Some engineers note that the term YOLO captures speed, but the path to production often hinges on compiler optimizations and hardware-tuned batching.
...
**Q:** How does YOLO implement real-time object detection using grid-based prediction and what are the key components of its architecture?

**A:** YOLO divides image into S×S grid, each cell predicts B bounding boxes with confidence scores, class probabilities, and uses anchor boxes for better localization.
...
1. [Achieving 1.85x higher performance for deep learning based object detection with an AWS Neuron compiled YOLOv4 model on AWS Inferentia](https://aws.amazon.com/blogs/machine-learning/improving-performance-for-deep-learning-based-object-detection-with-an-aws-neuron-compiled-yolov4-model-on-aws-inferentia) — article
2. [You Only Look Once: Unified, Real-Time Object Detection](https://arxiv.org/abs/1506.02640) — paper
3. [YOLOv3: An Incremental Improvement](https://arxiv.org/abs/1804.02767) — paper
4. [YOLO9000: Unified, Real-Time Object Detection](https://arxiv.org/abs/1612.08242) — paper
5. [SSD: Single Shot MultiBox Detector](https://arxiv.org/abs/1512.02325) — paper
6. [Faster R-CNN: Towards Real-Time Object Detection with Region Proposal Networks](https://arxiv.org/abs/1506.01497) — paper
7. [Intersection over union](https://en.wikipedia.org/wiki/Intersection_over_union) — Wikipedia
8. [Object detection](https://en.wikipedia.org/wiki/Object_detection) — Wikipedia
9. [YOLOv4: Optimal Speed and Accuracy of Object Detectors](https://arxiv.org/abs/2004.10934) — paper
10. [Darknet](https://github.com/AlexeyAB/darknet) — GitHub
11. [COCO (dataset)](https://en.wikipedia.org/wiki/COCO_(dataset)) — Wikipedia
12. [Efficient Non-Maximum Suppression](https://arxiv.org/abs/1705.02981) — paper
