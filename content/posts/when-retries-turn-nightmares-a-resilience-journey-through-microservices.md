...
description: "When Retries Turn Nightmares: A Resilience Journey Through Microservices"
...
|---|---|---|
| intermediate | system-design | resilience, circuit-breaker, retry-patterns, fault-tolerance, fallback-strategies |
...
> **Did you know?**
> Netflix built the inspiration for resilience patterns into its ecosystem long before many teams realized the trick: break glass early, test recovery often, and never let retries pull the entire system down.
...
1. [Our “Smart” Retry Logic Turned a 5-Minute Outage Into a 4-Hour Nightmare](https://medium.com/@lakshayaggarwal9/our-smart-retry-logic-turned-a-5-minute-outage-into-a-4-hour-nightmare-9a387fc364f7) — article
2. [Circuit breaker pattern](https://en.wikipedia.org/wiki/Circuit_breaker_pattern) — documentation
3. [Idempotence](https://en.wikipedia.org/wiki/Idempotence) — documentation
4. [RFC 6585: Additional HTTP Status Codes](https://datatracker.ietf.org/doc/html/rfc6585) — document
5. [Retry-After | MDN](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Retry-After) — documentation
6. [429 Too Many Requests | MDN](https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/429) — documentation
7. [API retries and exponential backoff | AWS](https://docs.aws.amazon.com/general/latest/gr/api-retries.html) — documentation
8. [Backoff and retries](https://en.wikipedia.org/wiki/Backoff) — documentation
9. [Retry patterns | Azure Architecture Center](https://learn.microsoft.com/en-us/azure/architecture/patterns/retry) — documentation
10. [Eventual consistency](https://en.wikipedia.org/wiki/Eventual_consistency) — documentation
11. [Distributed system](https://en.wikipedia.org/wiki/Distributed_system) — documentation
12. [What is Kubernetes? (Overview)](https://kubernetes.io/docs/concepts/overview/what-is-kubernetes/) — documentation
13. [Netflix Hystrix (GitHub)](https://github.com/Netflix/Hystrix) — repository
