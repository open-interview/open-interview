...
difficulty: beginner
tags: ["e2e-testing"]
description: "The 3am Pager: How I Learned to Stop Worrying and Love E2E Testing"
...
|---|---|---|
| beginner | e2e-testing | e2e-testing |
...
> **Did you know?**
> The term 'E2E testing' was coined in the 1970s when IBM needed to test mainframe systems that spanned multiple departments. The original tests literally ran from one 'end' of the company to the other, often taking days to complete!
...
1. [Playwright Documentation](https://playwright.dev/) — documentation
2. [Testing Best Practices - GitHub](https://github.com/goldbergyoni/javascript-testing-best-practices) — documentation
3. [The Testing Pyramid - Martin Fowler](https://martinfowler.com/bliki/TestPyramid.html) — blog
4. [End-to-End Testing - Wikipedia](https://en.wikipedia.org/wiki/End-to-end_testing) — documentation
5. [WebdriverIO vs Playwright Comparison](https://github.com/puppeteer/puppeteer) — documentation
6. [Test Automation Strategy - ArXiv](https://arxiv.org/abs/2301.06979) — paper
7. [JavaScript Async Testing - MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) — documentation
8. [Browser Automation Standards - W3C](https://www.w3.org/TR/webdriver/) — documentation
9. [Continuous Integration Testing - AWS](https://docs.aws.amazon.com/codepipeline/) — documentation
