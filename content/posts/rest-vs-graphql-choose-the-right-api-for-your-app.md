...
description: "REST vs GraphQL: Choose the Right API for Your App"
sources:
...
|---|---|---|
| intermediate | backend | rest, graphql, api |
...
> **Did you know?**
> GraphQL was created by Facebook in 2012 and open-sourced in 2015. It was originally developed to solve the exact problems we discussed—reducing network requests and eliminating over-fetching in their mobile apps. Today, it's used by companies ranging from startups to Fortune 500 enterprises.
...
1. [GraphQL Official Documentation](https://graphql.org/learn/) — documentation
2. [REST API Design Guide](https://restfulapi.net/) — documentation
3. [Netflix Engineering Blog - GraphQL Adoption](https://netflixtechblog.com/) — blog
