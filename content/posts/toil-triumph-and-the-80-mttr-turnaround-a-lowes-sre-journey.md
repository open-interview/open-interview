...
description: "Toil, Triumph, and the 80% MTTR Turnaround: A Lowe's SRE Journey"
question: What is Toil in Site Reliability Engineering and how should SREs approach managing it?
sources:
...
> **Did you know?**
> The term toil in SRE was popularized to distinguish low-value, repeatable work from meaningful engineering, a distinction that drives one of the most-watched productivity metrics in reliability teams.
...
**Q:** What is Toil in Site Reliability Engineering and how should SREs approach managing it?

**A:** Toil is repetitive, manual, automatable work that provides no enduring value. SREs should eliminate toil through automation to focus on engineering work.
...
1. [How Lowe’s SRE reduced its mean time to recovery (MTTR) by over 80 percent](https://cloud.google.com/blog/products/devops-sre/how-lowes-improved-incident-response-processes-with-sre) — article
2. [Eliminating Toil](https://sre.google/workbook/eliminating-toil/) — documentation
3. [Incident Response](https://sre.google/workbook/incident-response/) — documentation
4. [Postmortem Culture: Learning from Failure](https://sre.google/workbook/postmortem-culture/) — documentation
5. [Postmortem Analysis](https://sre.google/workbook/postmortem-analysis/) — documentation
6. [Incident Management Guide (PDF)](https://sre.google/static/pdf/IncidentManagementGuide.pdf) — paper
7. [Identifying and tracking toil using SRE principles](https://cloud.google.com/blog/products/management-tools/identifying-and-tracking-toil-using-sre-principles) — blog
8. [Site Reliability Engineering](https://en.wikipedia.org/wiki/Site_Reliability_Engineering) — documentation
9. [Site Reliability Engineering Key Concepts: SLO, Error Budget, TOIL and Observability](https://www.devopsinstitute.com/site-reliability-engineering-key-concepts-slo-error-budget-toil-and-observability/) — blog
10. [Incident Manager (AWS) Overview](https://docs.aws.amazon.com/incident-manager/latest/userguide/what-is-incident-manager.html) — documentation
11. [Site Reliability Engineering Handbook (New Relic)](https://newrelic.com/sites/default/files/2021-08/site-reliability-engineering-handbook.pdf) — paper
12. [Lowe's Case Study (Re-stated)](https://cloud.google.com/blog/products/devops-sre/how-lowes-improved-incident-response-processes-with-sre) — blog
