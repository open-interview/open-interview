...
description: "The Parallel Revelation: How Self-Attention Rewrote Translation (and How You Can Ride the Wave)"
question: How does the self-attention mechanism in transformers compute token relationships?
sources:
...
|---|---|---|
| intermediate | generative-ai | transformer, attention, tokenization |
...
> **Did you know?**
> The term attention echoes earlier alignment ideas in translation, highlighting which source tokens influenced each translation decision.
...
**Q:** How does the self-attention mechanism in transformers compute token relationships?

**A:** Self-attention computes token relationships by projecting each token into query, key, and value vectors, then calculating attention scores through scaled dot-product similarity, followed by softmax normalization and weighted aggregation of value vectors.
...
1. [Attention Is All You Need](https://papers.nips.cc/paper/7181-attention-is-all-you-need.pdf) — article
2. [Attention Is All You Need (arXiv)](https://arxiv.org/abs/1706.03762) — paper
3. [Transformer (machine learning) - Wikipedia](https://en.wikipedia.org/wiki/Transformer_(machine_learning)) — documentation
4. [Self-attention - Wikipedia](https://en.wikipedia.org/wiki/Self-attention) — documentation
5. [Neural Machine Translation by Jointly Learning to Align and Translate](https://arxiv.org/abs/1512.03385) — paper
6. [Hugging Face Transformers](https://github.com/huggingface/transformers) — documentation
7. [Fairseq: Facebook AI Research Sequence-to-Sequence Toolkit](https://github.com/pytorch/fairseq) — documentation
8. [TensorFlow Models](https://github.com/tensorflow/models) — documentation
9. [OpenNMT-py](https://github.com/OpenNMT/OpenNMT-py) — documentation
10. [Attention (machine learning) - Wikipedia](https://en.wikipedia.org/wiki/Attention_(machine_learning)) — documentation
