...
description: "The Zone That Became a Scheduler: A Real-World Tale of Deterministic Placement"
...
|---|---|---|
| intermediate | devops | custom-schedulers, kube-scheduler, workload-optimization, scheduler-plugins |
...
> **Did you know?**
> Many developers discover that the real killer is data locality, not just raw compute capacity.
...
1. [A Custom Kubernetes Scheduler to Orchestrate Highly Available Applications](https://kubernetes.io/blog/2020/12/21/writing-crl-scheduler/) — article
2. [Scheduling Framework](https://kubernetes.io/docs/concepts/scheduling/scheduling-framework/) — documentation
3. [StatefulSet - Kubernetes](https://kubernetes.io/docs/concepts/workloads/controllers/statefulset/) — documentation
4. [Scheduler Performance Tuning](https://kubernetes.io/docs/concepts/scheduling/scheduler-perf-tuning/) — documentation
5. [Kubernetes](https://en.wikipedia.org/wiki/Kubernetes) — article
6. [Kubernetes - Kubernetes](https://github.com/kubernetes/kubernetes) — blog
7. [Kueue: Kubernetes Queuing for Scheduling](https://github.com/kubernetes-sigs/kueue) — repository
8. [What is Kubernetes? - AWS](https://docs.aws.amazon.com/eks/latest/userguide/what-is-kubernetes.html) — documentation
9. [Container orchestration - Wikipedia](https://en.wikipedia.org/wiki/Container_orchestration) — article
10. [HTTP/1.1: RFC 2616](https://datatracker.ietf.org/doc/html/rfc2616) — documentation
