...
tags: ["linux"]
description: "Linux on Fire: A Netflix‑style 60‑Second Triage That Cracks Tail Latency"
...
> **Did you know?**
> Tail latency was a driving motivation behind Netflix’s adaptive streaming and microservice orchestration—tiny delays in the wrong place ripple into user-visible stalls.
...
1. [Netflix](https://en.wikipedia.org/wiki/Netflix) — article
2. [Kubernetes Documentation](https://kubernetes.io/docs/) — documentation
3. [What is CloudWatch](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.html) — documentation
4. [Perf Tools](https://github.com/brendangregg/perf-tools) — documentation
5. [RFC 7230 — HTTP/1.1](https://datatracker.ietf.org/doc/html/rfc7230) — documentation
6. [Linux performance analysis](https://en.wikipedia.org/wiki/Performance_analysis) — article
7. [Linux Kernel – Linux repository](https://github.com/torvalds/linux) — documentation
8. [AWS monitoring guide](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/monitoring_overview.html) — documentation
