...
difficulty: advanced
tags: ["linux"]
description: "The Midnight Mystery: Why Your Linux Server Lies About Memory"
...
> **Did you know?**
> The Linux OOM killer has a 'badness score' algorithm that decides which process to kill. It considers factors like memory usage, runtime, and whether the process is root. The algorithm is so complex that it's been rewritten multiple times, and engineers still debate its effectiveness!
...
1. [Linux Memory Management Documentation](https://www.kernel.org/doc/html/latest/vm/overcommit-accounting.html) — documentation
2. [Understanding the Linux OOM Killer](https://lwn.net/Articles/317814/) — blog
3. [Netflix Tech Blog: Memory Management at Scale](https://netflixtechblog.com/) — blog
4. [Linux Kernel Memory Pressure Interface](https://www.kernel.org/doc/html/latest/accounting/psi.html) — documentation
