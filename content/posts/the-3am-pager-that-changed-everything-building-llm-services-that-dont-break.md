...
tags: ["llm-ops"]
description: "The 3AM Pager That Changed Everything: Building LLM Services That Don't Break"
...
> **Did you know?**
> The first LLM service at Google (BERT) was so expensive to run that they initially limited it to just 1% of search queries. It took them 2 years of engineering work to make it cost-effective for full deployment.
...
1. [OpenAI Engineering Blog](https://openai.com/blog/chatgpt) — blog
2. [NVIDIA GPU Optimization Guide](https://docs.nvidia.com/deeplearning/performance/) — documentation
3. [Google AI Infrastructure Paper](https://arxiv.org/abs/2104.07857) — paper
4. [Meta LLM Infrastructure Talk](https://engineering.fb.com/2023/03/14/data-infrastructure/llm-inference/) — blog
