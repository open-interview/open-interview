...
description: "The Etsy Rule: How Feature Flags and Canary Deployments Enable Zero-Downtime at Scale"
...
|---|---|---|
| intermediate | devops | feature-flags, progressive-delivery, zero-downtime, canary-deployment, monitoring |
...
> **Did you know?**
> Many developers discover that a misconfigured flag can block a site-wide feature; governance and testing of flag configurations are crucial.
...
**Q:** How would you design a CI/CD pipeline that implements feature flagging and progressive delivery to enable zero-downtime deployments for a high-traffic e-commerce platform?

**A:** Implement feature flags with a progressive delivery strategy using canary deployments, real-time monitoring, and automated rollback capabilities to ensure zero-downtime releases.
...
1. [Etsy DevOps Case Study: The Secret to 50 Plus Deploys a Day](https://www.simform.com/blog/etsy-devops-case-study/) — article
2. [AWS CodeDeploy Canary Deployments](https://docs.aws.amazon.com/codedeploy/latest/userguide/deploying-canary.html) — documentation
3. [CodePipeline Overview](https://docs.aws.amazon.com/codepipeline/latest/userguide/welcome.html) — documentation
4. [Feature Toggle](https://en.wikipedia.org/wiki/Feature_toggle) — article
5. [Unleash (GitHub Repository)](https://github.com/Unleash/Unleash) — repository
6. [OpenFeature (GitHub Repository)](https://github.com/open-feature/spec) — repository
7. [RFC 7231 - HTTP/1.1 Semantics](https://datatracker.ietf.org/doc/html/rfc7231) — RFC
8. [LaunchDarkly (GitHub Organization)](https://github.com/launchdarkly) — repository
