...
difficulty: advanced
tags: ["api", "rest"]
description: "Rate Limiting Like a Boss: Surviving the 10M Request Apocalypse"
...
> **Did you know?**
> The token bucket algorithm was invented in the 1980s for telecommunication networks to control data flow in ATM switches. It's older than many developers reading this!
...
1. [Redis Cluster Best Practices](https://redis.io/docs/operate/oss_and_stack/management/cluster-tutorial/) — documentation
2. [Stripe API Rate Limiting](https://stripe.com/blog/rate-limiters) — blog
3. [Rate Limiting Algorithms Comparison](https://www.figma.com/blog/engineering/rate-limiting-at-scale/) — blog
4. [Token Bucket Algorithm Analysis](https://en.wikipedia.org/wiki/Token_bucket) — documentation
