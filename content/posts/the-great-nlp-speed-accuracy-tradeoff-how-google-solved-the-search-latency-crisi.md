...
description: "The Great NLP Speed-Accuracy Tradeoff: How Google Solved the Search Latency Crisis"
question: "What is the difference between tokenization and stemming in NLP text preprocessing, and when would you choose lemmatization over stemming?"
sources:
...
|---|---|---|
| beginner | nlp | tokenization, stemming, ner |
...
> **Did you know?**
> The Porter stemming algorithm was developed in 1979 by Martin Porter at the University of Cambridge and was originally written in BCPL, a programming language that predates C by nearly a decade. Despite its age, it remains one of the most widely used stemming algorithms in production systems today.
...
1. [More efficient search with better query understanding](https://ai.googleblog.com/2022/02/more-efficient-search-with-better.html) — blog
2. [Natural Language Processing: Tokenization](https://en.wikipedia.org/wiki/Tokenization_(lexical_analysis)) — documentation
3. [Stemming Algorithms Comparison](https://nlp.stanford.edu/IR-book/html/htmledition/stemming-and-lemmatization-1.html) — documentation
4. [Unicode Text Segmentation](https://unicode.org/reports/tr29/) — documentation
5. [Porter Stemmer Algorithm](https://tartarus.org/martin/PorterStemmer/) — documentation
6. [Snowball Stemming Language Support](https://snowballstem.org/) — documentation
7. [WordNet Lemmatizer](https://wordnet.princeton.edu/) — documentation
8. [NLTK Library Documentation](https://www.nltk.org/) — documentation
9. [spaCy NLP Library](https://spacy.io/) — documentation
10. [Information Retrieval Performance Metrics](https://en.wikipedia.org/wiki/Evaluation_measures_(information_retrieval)) — documentation
11. [Python Text Processing Libraries](https://docs.python.org/3/library/textwrap.html) — documentation
12. [Apache Lucene Tokenization](https://lucene.apache.org/core/) — documentation
