...
difficulty: beginner
tags: ["unix"]
description: "The 24-Hour Log Hunt: A One-Liner That Surfaces Busy Users (And Why Knight Capital's Lesson Still Matters)"
...
> **Did you know?**
> Some teams discovered that moving log analysis closer to the data and away from chained scripts reduced latency by orders of magnitude in high-volume environments.
...
1. [Knight Capital Group - Wikipedia](https://en.wikipedia.org/wiki/Knight_Capital_Group) — article
2. [Find (Unix) - Wikipedia](https://en.wikipedia.org/wiki/Find_(Unix)) — article
3. [Xargs - Wikipedia](https://en.wikipedia.org/wiki/Xargs) — article
4. [AWK - Wikipedia](https://en.wikipedia.org/wiki/AWK) — article
5. [Log rotation - Wikipedia](https://en.wikipedia.org/wiki/Log_rotation) — article
6. [POSIX - Wikipedia](https://en.wikipedia.org/wiki/POSIX) — article
7. [Regular expression - Wikipedia](https://en.wikipedia.org/wiki/Regular_expression) — article
8. [Unix - Wikipedia](https://en.wikipedia.org/wiki/Unix) — article
9. [Pipe (Unix) - Wikipedia](https://en.wikipedia.org/wiki/Pipe_(Unix)) — article
10. [System log - Wikipedia](https://en.wikipedia.org/wiki/System_log) — article
11. [GNU coreutils - GitHub](https://github.com/coreutils/coreutils) — documentation
