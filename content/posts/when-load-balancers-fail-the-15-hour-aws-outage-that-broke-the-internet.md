...
description: "When Load Balancers Fail: The 15-Hour AWS Outage That Broke the Internet"
...
|---|---|---|
| advanced | networking | infra, scale, networking |
...
> **Did you know?**
> The first load balancer was created in the 1990s at Cisco to handle the explosive growth of web traffic. Today, a single AWS Network Load Balancer can handle over 100 million TLS connections per second—more than the entire internet handled in 1995!
...
**Q:** Explain load balancing strategies and when to use Layer 4 vs Layer 7. How do round-robin, least connections, and IP hash algorithms compare?

**A:** Layer 4 uses TCP/UDP for faster performance with session persistence challenges. Layer 7 inspects HTTP headers for intelligent routing (path-based, host-based). Round-robin distributes evenly, least connections handles varying request loads, IP hash maintains session affinity. AWS ALB (L7) supports path-based routing while NLB (L4) offers ultra-low latency.
...
1. [Summary of the Amazon DynamoDB Service Disruption in the Northern Virginia (US-EAST-1) Region](https://aws.amazon.com/message/101925/) — article
2. [Load Balancing Health Checks](https://docs.aws.amazon.com/elasticloadbalancing/latest/application/target-health-checks.html) — documentation
3. [Network Load Balancer Features](https://docs.aws.amazon.com/elasticloadbalancing/latest/network/features.html) — documentation
4. [Application Load Balancer Features](https://docs.aws.amazon.com/elasticloadbalancing/latest/application/features.html) — documentation
5. [Load Balancing Algorithms](https://nginx.org/en/docs/http/load_balancing.html) — documentation
6. [IP Hash Load Balancing](https://www.nginx.com/resources/glossary/ip-hash/) — documentation
7. [Circuit Breaker Pattern](https://martinfowler.com/bliki/CircuitBreaker.html) — blog
8. [TCP Protocol Specification](https://datatracker.ietf.org/doc/html/rfc793) — documentation
9. [HTTP/1.1 Protocol Specification](https://datatracker.ietf.org/doc/html/rfc2616) — documentation
10. [Load Balancer Performance Metrics](https://docs.aws.amazon.com/elasticloadbalancing/latest/userguide/how-it-works.html#load-balancer-metrics) — documentation
11. [Kubernetes Service Load Balancing](https://kubernetes.io/docs/concepts/services-networking/service/) — documentation
