...
tags: ["terraform"]
description: "Active-Active DR Across Regions: A Terraform Tale Told in Data Bridges and Gatekeepers"
...
> **Did you know?**
> Many developers discover that the biggest DR hurdle isn't the tech—it's the governance and the data paths that connect regions without turning DR into a secret shadow of production.
...
1. [Terraform AWS S3 Backend](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/backends/s3) — documentation
2. [Creating an S3 Bucket (AWS)](https://docs.aws.amazon.com/AmazonS3/latest/userguide/creating-buckets.html) — documentation
3. [Disaster recovery](https://en.wikipedia.org/wiki/Disaster_recovery) — article
4. [The Terraform Project](https://github.com/hashicorp/terraform) — GitHub repo
5. [jq – Lightweight and flexible command-line JSON processor](https://github.com/stedolan/jq) — GitHub repo
6. [AWS Well-Architected Framework](https://docs.aws.amazon.com/wellarchitected/latest/framework/wellarchitected.html) — documentation
7. [JSON](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON) — documentation
8. [Terraform (software) - Wikipedia](https://en.wikipedia.org/wiki/Terraform_(software)) — article
9. [RFC 8259: The JavaScript Object Notation (JSON) Data Interchange Standard](https://www.rfc-editor.org/rfc/rfc8259.txt) — documentation
10. [Kubernetes Architecture](https://kubernetes.io/docs/concepts/architecture/) — documentation
