...
description: "The $2M Bug: How Stripe's Frontend Teams Broke Production and Fixed It Forever"
...
|---|---|---|
| intermediate | api-testing | wiremock, mockserver, msw |
...
> **Did you know?**
> The term "API drift" was coined by Netflix engineers in 2014 when they discovered that 37% of their frontend bugs were caused by outdated API mocks, leading them to pioneer automated contract testing approaches that are now industry standard.
...
1. [MSW Documentation](https://mswjs.io/docs/) — documentation
2. [OpenAPI Specification](https://github.com/OAI/OpenAPI-Specification) — documentation
3. [AJV JSON Schema Validator](https://github.com/ajv-validator/ajv) — documentation
4. [Service Worker API](https://developer.mozilla.org/en-US/docs/Web/API/Service_Worker_API) — documentation
5. [GitHub Actions Documentation](https://docs.github.com/en/actions) — documentation
6. [JSON Schema Validation](https://json-schema.org/) — documentation
7. [REST API Design Guidelines](https://restfulapi.net/) — blog
8. [API Versioning Best Practices](https://www.vinaysahni.com/best-practices-for-a-pragmatic-restful-api) — blog
9. [Continuous Integration for APIs](https://docs.github.com/en/actions/guides) — documentation
