...
description: "Database Types Compared: Choose the Right One"
sources:
...
> **Did you know?**
> The first commercial relational database, IBM's System R, was developed in the 1970s and cost over $1 million to create. Today, you can run more powerful databases on your laptop for free!
...
1. [Database Types Overview](https://www.mongodb.com/nosql-explained/nosql-vs-sql) — documentation
2. [Choosing the Right Database](https://aws.amazon.com/nosql/) — documentation
3. [NewSQL Database Comparison](https://cockroachlabs.com/blog/what-is-newsql/) — documentation
