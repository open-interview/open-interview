...
description: "The Night 10,000 Kubernetes Resources Almost Broke Production"
...
|---|---|---|
| advanced | kubernetes | crds, controllers, reconciliation |
...
> **Did you know?**
> The term 'operator' in Kubernetes comes from mathematical operators—just like math operators transform values, Kubernetes operators transform cluster state. The concept was pioneered by CoreOS in 2016 and has since become the standard for managing complex applications in Kubernetes.
...
1. [Kubernetes Controller Runtime Documentation](https://pkg.go.dev/sigs.k8s.io/controller-runtime) — documentation
2. [Netflix Titus Platform Architecture](https://netflixtechblog.com/titus-netflixs-container-management-platform-2e88d9234732) — blog
3. [Kubernetes Operator Best Practices](https://kubernetes.io/docs/operator-best-practices/) — documentation
4. [Google Cloud Operator Framework](https://cloud.google.com/blog/products/gcp/kubernetes-operators-best-practices) — blog
