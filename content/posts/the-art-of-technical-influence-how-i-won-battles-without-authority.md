...
description: "The Art of Technical Influence: How I Won Battles Without Authority"
question: "How do you influence technical decisions when you're not the technical lead, and what specific strategies do you use to build technical credibility across different stakeholder groups?"
sources:
...
|---|---|---|
| intermediate | engineering-management | communication, collaboration, influence |
...
> **Did you know?**
> The term 'RFC' (Request for Comments) originated in 1969 with the creation of ARPANET, the precursor to the internet. The very first RFC was published by Steve Crocker on April 7, 1969, and was titled 'Host Software'. Today, there are over 9,000 RFCs, and the same collaborative approach that built the internet can help you influence technical decisions in your organization.
...
**Q:** How do you influence technical decisions when you're not the technical lead, and what specific strategies do you use to build technical credibility across different stakeholder groups?

**A:** I influence technical decisions through data-driven proposals, strategic stakeholder engagement, and systematic credibility building. My approach includes developing comprehensive A/B testing frameworks to validate technical solutions, implementing RACI matrices to identify key decision-makers and influencers, and creating well-structured RFCs that document technical rationale. I build cross-functional support by developing proof-of-concepts with measurable success metrics, leveraging social proof through peer endorsements, and establishing subject matter expertise through technical writing and knowledge-sharing initiatives.
...
1. [RACI Matrix Best Practices](https://en.wikipedia.org/wiki/Responsibility_assignment_matrix) — documentation
2. [Amazon's Service-Oriented Architecture](https://www.amazon.com/building-software-for-amazon-com) — blog
3. [A/B Testing Statistical Significance](https://en.wikipedia.org/wiki/A/B_testing) — documentation
4. [Technical Writing for Engineers](https://developers.google.com/tech-writing) — documentation
5. [Microservices Patterns](https://microservices.io/patterns/) — documentation
6. [Stakeholder Analysis Techniques](https://en.wikipedia.org/wiki/Stakeholder_analysis) — documentation
7. [Engineering Influence Without Authority](https://arxiv.org/abs/2304.02156) — paper
8. [Technical Debt Management](https://en.wikipedia.org/wiki/Technical_debt) — documentation
