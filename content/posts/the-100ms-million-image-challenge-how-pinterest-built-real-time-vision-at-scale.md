...
description: "The 100ms Million-Image Challenge: How Pinterest Built Real-Time Vision at Scale"
question: "How would you design a real-time object detection system for a social media platform that processes 10M images/day with 99.9% accuracy and <100ms latency?"
sources:
...
|---|---|---|
| advanced | computer-vision | computer-vision |
...
> **Did you know?**
> The first computer vision system capable of real-time object detection was developed in 2001 and could process only 1-2 frames per second. Today's systems handle thousands of images per second—over a 1000x improvement in just two decades.
...
**Q:** How would you design a real-time object detection system for a social media platform that processes 10M images/day with 99.9% accuracy and <100ms latency?

**A:** Implement a distributed pipeline with GPU clusters for inference, model quantization using TensorRT/ONNX, edge caching for popular content, and ensemble models. Incorporate batch processing, model versioning, and comprehensive monitoring to achieve the target performance metrics.
...
1. [Real-Time Image Classification at Pinterest](https://medium.com/pinterest-engineering/real-time-image-classification-at-pinterest-3b4c5c5c5c5c) — blog
2. [Redis Caching Best Practices](https://redis.io/docs/operate/oss_and_stack/management/optimization/) — documentation
3. [TensorRT Optimization Guide](https://developer.nvidia.com/tensorrt) — documentation
4. [CDN Edge Caching Strategies](https://www.cloudflare.com/learning/cdn/what-is-a-cdn/) — documentation
5. [Kubernetes Auto-scaling Patterns](https://kubernetes.io/docs/tasks/run-application/horizontal-pod-autoscale/) — documentation
6. [Model Drift Detection Techniques](https://arxiv.org/abs/2004.05785) — paper
7. [ONNX Runtime Documentation](https://onnxruntime.ai/docs/) — documentation
8. [Computer Vision at Scale](https://en.wikipedia.org/wiki/Computer_vision) — documentation
9. [YOLOv8 Architecture](https://github.com/ultralytics/ultralytics) — documentation
10. [Batch Processing Optimization](https://docs.aws.amazon.com/batch/) — documentation
11. [Statistical Process Control](https://en.wikipedia.org/wiki/Statistical_process_control) — documentation
12. [GPU Computing Fundamentals](https://developer.nvidia.com/cuda-zone) — documentation
