...
description: "The 3am Pager That Changed Everything: How Netflix Learned to Stop Trusting JSON"
...
|---|---|---|
| intermediate | security | top10, asvs, samm |
...
> **Did you know?**
> The first JSON Schema specification was created in 2009 by Kris Zyp, who was inspired by XML Schema but wanted something simpler for JavaScript. Today, it's used by companies like Google, Microsoft, and Amazon to validate trillions of API requests daily.
...
**Q:** How would you implement OWASP ASVS L3 input validation for a REST API endpoint that accepts JSON payloads with nested objects?

**A:** Implement multi-layered validation using JSON Schema with strict whitelisting, recursive nested object validation, type and range constraints, and input sanitization at each level.
...
1. [OWASP Application Security Verification Standard](https://owasp.org/www-project-application-security-verification-standard/) — documentation
2. [Netflix Tech Blog: Building Resilient Microservices](https://netflixtechblog.com/building-resilient-microservices-3a2d1b3e5b5a) — blog
3. [JSON Schema Specification](https://json-schema.org/) — documentation
4. [Regular Expression Performance](https://www.regular-expressions.info/catastrophic.html) — documentation
