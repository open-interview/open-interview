...
description: "From Shopify’s Storefront to a Container-Powered Cloud: An Engineer’s Odyssey"
question: What is Docker and how does containerization differ from traditional virtualization in terms of architecture and resource efficiency?
sources:
...
|---|---|---|
| beginner | devops | docker, containers |
...
> **Did you know?**
> The idea of containerization traces back to chroot on Unix, a concept that evolved into modern container ecosystems like Docker and Kubernetes in the 2010s.
...
**Q:** What is Docker and how does containerization differ from traditional virtualization in terms of architecture and resource efficiency?

**A:** Docker is a containerization platform that packages apps with dependencies into lightweight containers sharing the host OS kernel, unlike VMs which require separate OS instances.
...
1. [Building an Internal Cloud with Docker and CoreOS](https://shopify.engineering/235340559-building-an-internal-cloud-with-docker-and-coreos) — article
2. [Docker Overview](https://docs.docker.com/engine/docker-overview/) — documentation
3. [What is Kubernetes?](https://kubernetes.io/docs/concepts/overview/what-is-kubernetes/) — documentation
4. [How to Install Docker on Ubuntu (DigitalOcean)](https://www.digitalocean.com/community/tutorials/how-to-install-docker-on-ubuntu) — tutorial
5. [Moby (Docker Engine) - GitHub](https://github.com/moby/moby) — repo
6. [Simian Army (Chaos Monkey) - GitHub](https://github.com/Netflix/Simian Army) — repo
7. [Chaos Monkey](https://en.wikipedia.org/wiki/Chaos_Monkey) — documentation
8. [Docker (software) - Wikipedia](https://en.wikipedia.org/wiki/Docker_(software)) — documentation
9. [Amazon ECS (Elastic Container Service) Overview](https://docs.aws.amazon.com/ecs/index.html) — documentation
10. [AWS Fargate](https://docs.aws.amazon.com/fargate/index.html) — documentation
11. [RFC 7230: Hypertext Transfer Protocol (HTTP/1.1) Message Syntax and Routing](https://datatracker.ietf.org/doc/html/rfc7230) — documentation
12. [Container (virtualization) - Wikipedia](https://en.wikipedia.org/wiki/Container_(virtualization)) — documentation
