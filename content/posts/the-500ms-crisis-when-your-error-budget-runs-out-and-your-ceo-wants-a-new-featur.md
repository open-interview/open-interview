...
description: "The 500ms Crisis: When Your Error Budget Runs Out and Your CEO Wants a New Feature"
question: "Your SLO for API response time is 99.9% with a 500ms threshold. You're at 99.7% and the error budget is exhausted. The product team wants to ship a new feature that will increase traffic by 20%. How do you handle this situation?"
sources:
...
|---|---|---|
| intermediate | sre | slo, sli, error-budget |
...
> **Did you know?**
> The term 'error budget' was coined at Google in 2016. Before that, teams either aimed for 100% reliability (impossible) or had no clear targets. The concept revolutionized how we think about reliability vs. innovation.
...
**Q:** Your SLO for API response time is 99.9% with a 500ms threshold. You're at 99.7% and the error budget is exhausted. The product team wants to ship a new feature that will increase traffic by 20%. How do you handle this situation?

**A:** Implement a feature freeze to prioritize stability, conduct a thorough analysis of performance bottlenecks to identify optimization opportunities, optimize existing services to improve response times, and then gradually roll out the new feature using a canary deployment approach with continuous monitoring.
...
1. [Site Reliability Engineering Workbook](https://sre.google/workbook/error-budget-policy/) — documentation
2. [Canary Analysis Patterns](https://github.com/GoogleCloudPlatform/continuous-deployment-on-kubernetes) — documentation
3. [AWS Well-Architected Framework - Reliability](https://docs.aws.amazon.com/wellarchitected/latest/reliability-pillar/) — documentation
4. [Kubernetes Deployment Strategies](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/#strategy) — documentation
5. [RFC 2119 - Requirement Levels](https://datatracker.ietf.org/doc/html/rfc2119) — documentation
6. [Amazon S3 Incident Post-Mortem](https://aws.amazon.com/message/41926/) — blog
7. [Web Performance Budgets](https://developer.mozilla.org/en-US/docs/Web/Performance) — documentation
8. [Chaos Engineering Principles](https://github.com/Netflix/chaosmonkey) — documentation
9. [Service Level Objectives](https://en.wikipedia.org/wiki/Service_level_objective) — documentation
