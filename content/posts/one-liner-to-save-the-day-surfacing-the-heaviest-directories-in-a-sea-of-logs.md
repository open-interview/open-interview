...
difficulty: beginner
tags: ["unix"]
description: "One-Liner to Save the Day: Surfacing the Heaviest Directories in a Sea of Logs"
...
> **Did you know?**
> Two-phase compression, a strategy Uber explored, demonstrates how moving work closer to data generation can unlock orders of magnitude in storage savings.
...
1. [Reducing Logging Cost by Two Orders of Magnitude using CLP](https://www.uber.com/blog/reducing-logging-cost-by-two-orders-of-magnitude-using-clp/) — article
2. [Data compression](https://en.wikipedia.org/wiki/Data_compression) — documentation
3. [du (GNU core utilities manual)](https://www.gnu.org/software/coreutils/manual/coreutils.html#du) — documentation
4. [shutil.disk_usage](https://docs.python.org/3/library/shutil.html#shutil.disk_usage) — documentation
5. [os.walk](https://docs.python.org/3/library/os.html#os.walk) — documentation
6. [File system](https://en.wikipedia.org/wiki/File_system) — documentation
7. [Lossless data compression](https://en.wikipedia.org/wiki/Lossless_data_compression) — documentation
8. [TLDR](https://github.com/tldr-pages/tldr) — documentation
