...
tags: ["terraform"]
description: "Guardrails in the Multi-Account Cloud: Drift, Tags, and Isolation"
...
|---|---|---|
| intermediate | terraform | terraform |
...
> **Did you know?**
> Many organizations discover that the hardest part of multi-account governance isn’t the first deployment, but preventing drift once dozens of accounts are in flight.
...
1. [Manage your AWS multi-account environment with Account Factory for Terraform (AFT)](https://aws.amazon.com/blogs/mt/manage-your-aws-multi-account-environment-with-account-factory-for-terraform-aft/) — article
2. [Account Factory for Terraform (AFT) with Control Tower](https://docs.aws.amazon.com/controltower/latest/userguide/account-factory-for-terraform.html) — documentation
3. [Guardrails in AWS Control Tower](https://docs.aws.amazon.com/controltower/latest/userguide/guardrails.html) — documentation
4. [AWS IAM Identity Center (formerly AWS SSO) overview](https://docs.aws.amazon.com/singlesignon/latest/userguide/what-is.html) — documentation
5. [Terraform: Backend configuration (S3) and state management](https://www.terraform.io/language/settings/backends/s3) — documentation
6. [GitHub: terraform-aws-modules/terraform-aws-vpc](https://github.com/terraform-aws-modules/terraform-aws-vpc) — github
7. [GitHub: hashicorp/terraform](https://github.com/hashicorp/terraform) — github
8. [DevOps - Wikipedia](https://en.wikipedia.org/wiki/DevOps) — documentation
9. [AWS Organizations - Introduction](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_introduction.html) — documentation
