...
description: "The 3am Pager: How We Broke the Internet (and Fixed It)"
...
|---|---|---|
| intermediate | performance-testing | jmeter, k6, gatling, locust |
...
> **Did you know?**
> The term "load testing" was coined in the 1960s when IBM needed to test their mainframe systems. They would literally have hundreds of operators typing commands simultaneously to simulate peak load. Today, one k6 script can do what took hundreds of people back then.
...
**Q:** How would you design a distributed load testing setup using k6 with multiple cloud regions to simulate 100k concurrent users while avoiding rate limiting and ensuring accurate metrics collection?

**A:** Use k6 cloud with distributed execution across regions, implement exponential ramp-up, and aggregate results via cloud backend with custom metrics.
...
1. [k6 Cloud Documentation](https://k6.io/docs/cloud/get-started/) — documentation
2. [Netflix Chaos Engineering](https://netflixtechblog.com/chaos-engineering-the-origins-6f1d8b0c0b6) — blog
3. [Distributed Load Testing Best Practices](https://k6.io/docs/testing-guides/distributed-testing/) — documentation
