...
tags: ["linux"]
description: "Latency Unmasked: A Triaged Journey Through Linux Kernel Hurdles"
...
> **Did you know?**
> Kernel networking behaviors can dominate tail latency even when user-space metrics look clean—mere microseconds of stall can cascade into seconds of user-perceived delay.
...
1. [The story of one latency spike](https://blog.cloudflare.com/the-story-of-one-latency-spike/) — article
2. [Disk scheduling](https://en.wikipedia.org/wiki/Disk_scheduling) — documentation
3. [HTTP](https://developer.mozilla.org/en-US/docs/Web/HTTP) — documentation
4. [Linux kernel](https://github.com/torvalds/linux) — GitHub repo
5. [TCP Congestion Control (RFC)](https://datatracker.ietf.org/doc/html/rfc5681) — document
6. [Python docs](https://docs.python.org/3/) — documentation
7. [AWS EC2/EBS performance](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html) — documentation
8. [Kubernetes networking](https://kubernetes.io/docs/concepts/services-networking/) — documentation
9. [Network interface card offloads](https://en.wikipedia.org/wiki/Network_interface_controller#Offload_features) — documentation
10. [Linux I/O scheduling overview](https://en.wikipedia.org/wiki/Disk_scheduling) — documentation
11. [DigitalOcean Community Tutorials](https://www.digitalocean.com/community/tutorials) — documentation
