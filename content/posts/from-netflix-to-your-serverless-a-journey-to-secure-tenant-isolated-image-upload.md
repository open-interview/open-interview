...
difficulty: beginner
tags: ["aws"]
description: "From Netflix to Your Serverless: A Journey to Secure, Tenant-Isolated Image Upload on AWS"
...
> **Did you know?**
> The term serverless is a bit of misdirection: servers still exist, but developers focus on code and events, not provisioning servers for every load spike.
...
1. [Netflix](https://en.wikipedia.org/wiki/Netflix) — documentation
2. [IAM Best Practices](https://docs.aws.amazon.com/IAM/latest/UserGuide/best-practices.html) — documentation
3. [Example bucket policies](https://docs.aws.amazon.com/AmazonS3/latest/userguide/example-bucket-policies.html) — documentation
4. [Lambda permissions](https://docs.aws.amazon.com/lambda/latest/dg/lambda-permissions.html) — documentation
5. [Fine-Grained Access Control in DynamoDB](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/FineGrainedAccessControl.html) — documentation
6. [IAM policy elements and conditions](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition_operators.html) — documentation
7. [S3 Notification How-To](https://docs.aws.amazon.com/AmazonS3/latest/userguide/NotificationHowTo.html) — documentation
8. [PutItem API Reference](https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_PutItem.html) — documentation
9. [Policy Simulator](https://policysim.aws.amazon.com/home/index.jsp) — documentation
10. [Serverless Image Handler](https://github.com/awslabs/serverless-image-handler) — documentation
11. [Lambda with S3 triggers](https://docs.aws.amazon.com/lambda/latest/dg/with-s3.html) — documentation
12. [Serverless Computing](https://en.wikipedia.org/wiki/Serverless_computing) — documentation
13. [AWS SAM: What is SAM?](https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/what-is-sam.html) — documentation
