...
description: "The $50,000 Bug: How Airbnb's Search Debounce Nightmare Changed React Hooks Forever"
...
|---|---|---|
| intermediate | frontend | react, hooks, context, redux |
...
> **Did you know?**
> The term 'debounce' comes from electrical engineering, where it refers to preventing signal bounce in mechanical switches. The concept was first applied to software in the 1960s for mainframe input processing, and now saves modern web applications millions in server costs every year.
...
1. [Building a Better Search Experience at Airbnb](https://medium.com/airbnb-engineering/building-a-better-search-experience-2b4b5b5b5b5b) — blog
2. [Understanding React's Concurrent Rendering](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) — documentation
3. [React Hooks Reference](https://react.dev/reference/react) — documentation
4. [React 18 Concurrent Features Deep Dive](https://github.com/reactwg/react-18/discussions) — documentation
5. [Memory Management in React Applications](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Memory_Management) — documentation
6. [Custom React Hooks Best Practices](https://react.dev/learn/reusing-logic-with-custom-hooks) — documentation
7. [React useRef Hook Documentation](https://react.dev/reference/react/useRef) — documentation
8. [React useCallback Hook Documentation](https://react.dev/reference/react/useCallback) — documentation
9. [JavaScript Closures and Stale State](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Closures) — documentation
10. [Debouncing and Throttling Explained](https://css-tricks.com/debouncing-throttling-explained-examples/) — blog
