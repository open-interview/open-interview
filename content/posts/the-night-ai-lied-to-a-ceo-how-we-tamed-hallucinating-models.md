...
description: "The Night AI Lied to a CEO: How We Tamed Hallucinating Models"
...
|---|---|---|
| beginner | generative-ai | hallucination, faithfulness, relevance |
...
> **Did you know?**
> The term 'AI hallucination' was coined in 2020, but the phenomenon has existed since the first ELIZA chatbot in 1966. Early chatbots would often 'hallucinate' by making up responses when they didn't understand input—a problem that's surprisingly similar to what we face with modern LLMs!
...
**Q:** How would you measure and reduce hallucination in a large language model deployed for customer service?

**A:** Implement faithfulness scoring using retrieval-augmented generation and human evaluation pipelines to quantify and minimize hallucinations.
...
1. [Retrieval-Augmented Generation for Knowledge-Intensive Tasks](https://arxiv.org/abs/2005.11401) — paper
2. [Factuality Enhanced Language Models](https://arxiv.org/abs/2212.09910) — paper
3. [Measuring Faithfulness in LLMs](https://arxiv.org/abs/2304.09925) — paper
4. [RAG Documentation](https://docs.python.org/3/) — documentation
5. [Hallucination Detection Methods](https://en.wikipedia.org/wiki/Hallucination_(artificial_intelligence)) — documentation
6. [Human-in-the-Loop Machine Learning](https://en.wikipedia.org/wiki/Human-in-the-loop) — documentation
7. [Confidence Scoring in AI Systems](https://arxiv.org/abs/2205.14791) — paper
8. [AI Safety and Reliability](https://en.wikipedia.org/wiki/AI_safety) — documentation
9. [Enterprise AI Deployment Best Practices](https://docs.aws.amazon.com/) — documentation
10. [AI Trust and Reliability Framework](https://arxiv.org/abs/2306.02307) — paper
