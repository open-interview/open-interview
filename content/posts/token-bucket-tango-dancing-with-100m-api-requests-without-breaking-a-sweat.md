...
difficulty: advanced
tags: ["api", "rest"]
description: Token Bucket Tango - Dancing With 100M API Requests Without Breaking a Sweat
...
|---|---|---|
| advanced | system-design | api, rest |
...
> **Did you know?**
> The token bucket algorithm was originally invented in the 1980s for network traffic management in ATM (Asynchronous Transfer Mode) networks. It's older than many of the developers using it today!
...
1. [Redis Lua Scripting Documentation](https://redis.io/docs/manual/programmability/) — documentation
2. [Stripe Engineering - Rate Limiting at Scale](https://stripe.com/blog/rate-limiters) — blog
3. [Netflix Rate Limiting Architecture](https://netflixtechblog.com/rate-limiting-at-netflix-7c8a9c0b1f7a) — blog
4. [Token Bucket Algorithm Research Paper](https://www.cs.ucdavis.edu/~vemuri/classes/ecs251/papers/token-bucket.pdf) — paper
