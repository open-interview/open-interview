...
description: "Kubernetes Ambient Mesh: Future of Service Mesh"
sources:
...
|---|---|---|
| advanced | kubernetes | kubernetes, ambient-mesh, service-mesh |
...
> **Did you know?**
> Ambient mesh can reduce the number of proxies in a 100-pod deployment from 100 sidecars to just 1 ztunnel per node plus 2-3 waypoint proxies, representing a 95% reduction in proxy count!
...
1. [Istio Ambient Mesh Architecture](https://istio.io/latest/docs/concepts/ambient/) — documentation
2. [Ambient Mesh Performance Benchmarks](https://istio.io/latest/blog/ambient-performance/) — blog
3. [eBPF Technology Overview](https://ebpf.io/what-is-ebpf/) — documentation
4. [Kubernetes Service Mesh Comparison](https://kubernetes.io/docs/concepts/services-networking/service-mesh/) — documentation
5. [Zero Trust Security in Service Mesh](https://istio.io/latest/docs/concepts/security/) — documentation
6. [Ambient Mesh Migration Guide](https://istio.io/latest/docs/setup/ambient/migration/) — documentation
7. [CNCF Service Mesh Landscape](https://landscape.cncf.io/category=service-mesh) — landscape
8. [Waypoint Proxy Configuration](https://istio.io/latest/docs/setup/ambient/waypoint/) — documentation
9. [Service Mesh Performance Study](https://github.com/istio/istio/wiki/Performance-Benchmarking) — github
10. [Kubernetes Network Policies](https://kubernetes.io/docs/concepts/services-networking/network-policies/) — documentation
11. [mTLS in Service Mesh](https://istio.io/latest/docs/tasks/security/authentication/) — documentation
12. [eBPF for Service Mesh](https://cilium.io/docs/concepts/kubernetes/ebpf/) — documentation
13. [Service Mesh Observability](https://istio.io/latest/docs/tasks/observability/) — documentation
