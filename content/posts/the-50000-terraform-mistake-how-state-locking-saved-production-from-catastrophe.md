...
description: "The $50,000 Terraform Mistake: How State Locking Saved Production from Catastrophe"
...
|---|---|---|
| advanced | terraform | dry, terragrunt, atlantis |
...
> **Did you know?**
> The term "blue-green deployment" originated from telecommunications, where companies would maintain duplicate switching centers (colored blue and green on network diagrams) to ensure service continuity during maintenance or failures.
...
1. [Mastering Terraform State: Real Incidents, Lessons, and Best Practices](https://tothenew.com/blog/mastering-terraform-state-real-incidents-lessons-and-best-practices) — blog
2. [Terraform State Locking](https://www.terraform.io/docs/language/state/locking.html) — documentation
3. [Blue-Green Deployment Pattern](https://docs.aws.amazon.com/whitepapers/latest/blue-green-deployments/blue-green-deployments.html) — documentation
4. [Terraform Workspaces Documentation](https://www.terraform.io/docs/language/state/workspaces.html) — documentation
5. [Atlantis Open Source Project](https://github.com/runatlantis/atlantis) — documentation
6. [AWS Application Load Balancer](https://docs.aws.amazon.com/elasticloadbalancing/latest/application/introduction.html) — documentation
7. [ALB Health Check Configuration](https://docs.aws.amazon.com/elasticloadbalancing/latest/application/target-group-health-checks.html) — documentation
8. [Terraform State Drift Detection](https://www.terraform.io/docs/cli/commands/plan.html#detecting-drift) — documentation
9. [Terraform S3 Backend with DynamoDB Locking](https://www.terraform.io/docs/language/settings/backends/s3.html) — documentation
10. [Health Check Timeout Best Practices](https://docs.aws.amazon.com/elasticloadbalancing/latest/application/target-group-health-checks.html#health-check-settings) — documentation
11. [DNS TTL Configuration](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/ResourceRecordTTL.html) — documentation
