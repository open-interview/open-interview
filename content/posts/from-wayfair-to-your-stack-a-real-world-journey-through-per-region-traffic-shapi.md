...
tags: ["sre"]
description: "From Wayfair to Your Stack: A Real-World Journey Through Per-Region Traffic Shaping"
...
> **Did you know?**
> Many developers discover the term Cyber 5 as a peak-traffic window; a well-tuned traffic shaping engine can shave seconds off latency during those surges.
...
1. [Case Study - Traffic Shaping](https://www.tremor.rs/blog/2021/11/02/traffic-shaping) — article
2. [Circuit breaker design pattern](https://en.wikipedia.org/wiki/Circuit_breaker_design_pattern) — documentation
3. [Token Bucket](https://en.wikipedia.org/wiki/Token_bucket) — documentation
4. [Backpressure](https://en.wikipedia.org/wiki/Backpressure) — documentation
5. [Canary release](https://en.wikipedia.org/wiki/Canary_release) — documentation
6. [Service-level objective](https://en.wikipedia.org/wiki/Service-level_objective) — documentation
7. [Rate limiting](https://en.wikipedia.org/wiki/Rate_limiting) — documentation
8. [HTTP/1.1 - RFC 7231](https://datatracker.ietf.org/doc/html/rfc7231) — documentation
9. [HTTP 429 Too Many Requests](https://datatracker.ietf.org/doc/html/rfc6585) — documentation
10. [Kubernetes: Resource quotas](https://kubernetes.io/docs/concepts/policy/resource-quotas/) — documentation
11. [AWS API Gateway limits](https://docs.aws.amazon.com/apigateway/latest/developerguide/limits.html) — documentation
