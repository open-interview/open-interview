...
description: "Uber's 2016 Data Breach: The MFA Gap That Exposed 57 Million Riders and Drivers"
sources:
...
|---|---|---|
| advanced | security | security, data-breach, mfa |
...
> **Did you know?**
> The breach led to one of the most high-profile discussions of third-party risk in cloud environments and accelerated industry moves toward stronger vendor security programs.
...
1. [Postmortem: 2016 data breach](https://www.uber.com/blog/engineering/security/postmortem-2016-data-breach/) — postmortem
2. [Uber Paid Hackers to Delete Data Breach](https://www.bloomberg.com/news/articles/2017-11-21/uber-paid-hackers-to-delete-data-breach) — news
3. [Uber breach: what happened, what it meant](https://www.nytimes.com/2017/11/21/technology/uber-hack.html) — news
4. [Uber’s 2016 data breach: what went wrong and why it mattered](https://www.reuters.com/article/us-uber-cybersecurity-idUSKBN1D52L8) — news
5. [Uber data breach highlights: lessons for security teams](https://arstechnica.com/security/2017/11/uber-data-breach-57-million-what-it-means-for-security-teams) — news
6. [AWS Security Best Practices](https://aws.amazon.com/blogs/security/security-best-practices-in-aws/) — documentation
7. [NIST SP 800-53: Security and Privacy Controls](https://csrc.nist.gov/publications/nist-sp-800-53) — documentation
8. [OWASP Top Ten](https://owasp.org/www-project/top-ten/) — documentation
