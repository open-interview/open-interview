...
description: "The Build at Scale: How to Ship a Rust Microservice with BuildKit Secrets, Cargo Caching, and a Minimal Runtime"
...
> **Did you know?**
> Many teams report noticeable improvements in build throughput after warming cargo and git caches in the first few runs; subsequent builds become near-deterministic in duration.
...
1. [uBuild: Fast and Safe Building of Thousands of Container Images](https://www.uber.com/blog/ubuild-fast-and-safe-building-of-thousands-of-container-images/) — article
2. [Docker Buildx](https://github.com/docker/buildx) — documentation
3. [Moby BuildKit](https://github.com/moby/buildkit) — documentation
4. [Cargo (Rust package manager)](https://github.com/rust-lang/cargo) — documentation
5. [Docker Compose](https://github.com/docker/compose) — documentation
6. [Kubernetes Secrets](https://kubernetes.io/docs/concepts/configuration/secret/) — documentation
7. [Docker (software) - Wikipedia](https://en.wikipedia.org/wiki/Docker_(software)) — documentation
8. [Containerization - Wikipedia](https://en.wikipedia.org/wiki/Containerization) — documentation
9. [AWS CodeBuild: Docker Images](https://docs.aws.amazon.com/codebuild/latest/userguide/docker-images.html) — documentation
10. [AWS CodeBuild: Build Spec Reference](https://docs.aws.amazon.com/codebuild/latest/userguide/build-spec-ref.html) — documentation
