...
tags: ["llm-ops"]
description: The Netflix-Inspired Playbook for Zero-Downtime Upgrades Across Three Regions
...
> **Did you know?**
> Many developers discover that the hardest part isn’t the rollout itself but the instrumentation needed to make the health signals trustworthy.
...
1. [Introducing Kayenta: An open automated canary analysis tool from Google and Netflix](https://cloud.google.com/blog/products/gcp/introducing-kayenta-an-open-automated-canary-analysis-tool-from-google-and-netflix) — article
2. [Canary release](https://en.wikipedia.org/wiki/Canary_release) — documentation
3. [Kubernetes Deployments - Rolling updates](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/) — documentation
4. [AWS CodeDeploy - Deployments: Rolling](https://docs.aws.amazon.com/codedeploy/latest/userguide/deployments-rolling.html) — documentation
5. [HTTP Status Codes - MDN](https://developer.mozilla.org/en-US/docs/Web/HTTP/Status) — documentation
6. [RFC 7231 - HTTP/1.1 Semantics](https://datatracker.ietf.org/doc/html/rfc7231) — paper
7. [Kayenta (Spinnaker) GitHub](https://github.com/spinnaker/kayenta) — repository
8. [Istio – Canary deployments](https://github.com/istio/istio) — repository
9. [Prometheus - GitHub](https://github.com/prometheus/prometheus) — repository
10. [Amazon CloudWatch - What is CloudWatch?](https://docs.aws.amazon.com/cloudwatch/index.html) — documentation
