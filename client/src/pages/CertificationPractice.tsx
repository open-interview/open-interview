          ...
          <div className="bg-muted/30 border-b border-border px-3 py-2">
            <div className="max-w-7xl mx-auto flex items-center justify-between text-xs">
              <div className="flex items-center gap-4">
                <span><span className="text-foreground/70">Level:</span> <span className="font-medium capitalize">{certification.difficulty}</span></span>
                <span><span className="text-foreground/70">Time:</span> <span className="font-medium">{certification.estimatedHours}h</span></span>
                <span><span className="text-foreground/70">Done:</span> <span className="font-medium">{completedIds.size}/{totalQuestions}</span></span>
              </div>
