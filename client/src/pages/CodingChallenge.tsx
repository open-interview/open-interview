            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12 pb-safe">
              ...
              >
                <div className="p-4 md:p-6 bg-muted/50 border border-border rounded-2xl">
                  ...
                  <div className="text-2xl md:text-3xl font-bold mb-1">{stats.passedChallenges}</div>
                ...
                <div className="p-4 md:p-6 bg-muted/50 border border-border rounded-2xl">
                  ...
                  <div className="text-2xl md:text-3xl font-bold mb-1">{stats.totalAttempts}</div>
                ...
                <div className="p-4 md:p-6 bg-muted/50 border border-border rounded-2xl">
                  ...
                  <div className="text-2xl md:text-3xl font-bold mb-1">{challenges.length}</div>
                ...
                <div className="p-4 md:p-6 bg-gradient-to-br from-[#ffd700]/20 to-[#ff0080]/20 border border-[#ffd700]/30 rounded-2xl">
                  ...
                  <div className="text-2xl md:text-3xl font-bold mb-1">{formatCredits(balance)}</div>
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
                  ...
                  >
                    ...
                    <div className="text-base md:text-lg font-bold mb-1">Random Challenge</div>
                  ...
                  >
                    <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-[#00ff88]/20 flex items-center justify-center mb-2 md:mb-3 group-hover:scale-110 transition-transform">
                      <span className="text-primary font-bold text-sm md:text-base">E</span>
                    </div>
                    <div className="text-base md:text-lg font-bold mb-1">Easy Mode</div>
                  ...
                  >
                    <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-[#ffd700]/20 flex items-center justify-center mb-2 md:mb-3 group-hover:scale-110 transition-transform">
                      <span className="text-[#ffd700] font-bold text-sm md:text-base">M</span>
                    </div>
                    <div className="text-base md:text-lg font-bold mb-1">Medium Mode</div>
              ...
              >
                <h2 className="text-lg md:text-xl font-bold mb-3 md:mb-4">ALL CHALLENGES</h2>
              ...
              <header className="border-b border-border bg-background/95 backdrop-blur-md sticky top-0 z-50 pt-safe">
                <div className="px-3 md:px-6 py-3 md:py-4 flex items-center justify-between gap-2 md:gap-4">
                  <div className="flex items-center gap-2 md:gap-4 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      <h2 className="font-bold text-sm md:text-lg truncate">{currentChallenge.title}</h2>
              ...
              <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
                ...
                <div className="md:w-[450px] border-b md:border-b-0 md:border-r border-border flex flex-col overflow-hidden max-h-[40vh] md:max-h-none">
                  <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 md:space-y-6">
                    {/* Description */}
                    <div>
                      <h3 className="text-xs md:text-sm font-bold text-primary mb-2 md:mb-3 uppercase tracking-wider">Problem</h3>
                    ...
                    {/* Examples */}
                    <div>
                      <h3 className="text-xs md:text-sm font-bold text-cyan-500 mb-2 md:mb-3 uppercase tracking-wider">Examples</h3>
                      <div className="space-y-2 md:space-y-3">
                    ...
                    {userComplexity && (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                      >
                        <h3 className="text-sm font-bold text-[#ff0080] mb-3 uppercase tracking-wider flex items-center gap-2">
                ...
                <div className="flex-1 flex flex-col overflow-hidden min-h-0">
                        ...
                        {allPassed ? (
                          <>
                            ...
                            <div className="min-w-0">
                              <div className="font-bold text-sm md:text-base text-primary">All Tests Passed!</div>
                          ...
                          <>
                            ...
                            <div className="min-w-0">
                              <div className="font-bold text-sm md:text-base text-[#ff0080]">
                  ...
                  <div className="border-t border-border p-3 md:p-4 flex items-center justify-between bg-background/95 pb-safe">
                    ...
                    <button
                      onClick={runCode}
                      disabled={isRunning}
                      className="flex items-center gap-2 px-4 md:px-6 py-2 md:py-3 bg-gradient-to-r from-primary to-cyan-500 text-primary-foreground font-bold text-sm md:text-base rounded-xl hover:from-primary/90 hover:to-cyan-500/90 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isRunning ? (
                        <>
                ...
                >
                  ...
                  <div className="p-4 md:p-6 overflow-y-auto max-h-[calc(85vh-120px)] md:max-h-[60vh]">
                    ...
                    <div className="mt-4 md:mt-6 p-4 md:p-6 bg-[#00ff88]/10 border border-primary/30 rounded-2xl">
                      <h3 className="text-xs md:text-sm font-bold text-primary mb-3 md:mb-4 uppercase tracking-wider flex items-center gap-2">
            ...
            {showSuccessModal && (
              ...
              >
                ...
                >
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mb-2">Challenge Complete!</h2>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <button
                      ...
                      className="flex-1 py-3 bg-gradient-to-r from-primary to-cyan-500 text-primary-foreground font-bold text-sm md:text-base rounded-xl hover:from-primary/90 hover:to-cyan-500/90 transition-all"
                    >
                      Next Challenge →
                    </button>
                    <button
